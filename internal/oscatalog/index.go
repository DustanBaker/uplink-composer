...
const (
	IndexURL    = "https://raw.githubusercontent.com/DustanBaker/uplink-composer/main/catalog/index.json"
...
// Source describes where the current list came from, for `uplink catalog`
